...
namespace DoggyCare
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Create a single instance of the db repository
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DoggyCare", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DoggyCare v1"));
            }
