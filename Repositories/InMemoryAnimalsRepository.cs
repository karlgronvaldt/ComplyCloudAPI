...
namespace DoggyCare.Repositories
{
    public class InMemoryAnimalsRepository : IAnimalsRepository
    {
        ...
        {
            new AnimalModel { Id = Guid.NewGuid(), Type = 1, Name = "Johnny", Breed = "Chiuaua", Allergy = "None", Owner = "Karl", CreatedDate = DateTime.Now },
            new AnimalModel { Id = Guid.NewGuid(), Type = 1, Name = "Doggo", Breed = "Labrador", Allergy = "Tomato", Owner = "Luna", CreatedDate = DateTime.Now },
            new AnimalModel { Id = Guid.NewGuid(), Type = 1, Name = "Pipi", Breed = "Golden Retreiver", Allergy = "Chalk", Owner = "Olaf", CreatedDate = DateTime.Now }
        };
